...
function CoverLayout({
  ...
  cardContent,
  children,
  showNavbar = true, // Add showNavbar prop with default value true
}) {
  ...
  return (
    ...
    >
      {/* Conditionally render DefaultNavbar based on showNavbar prop */}
      {showNavbar && (
        <DefaultNavbar
          action={{
            type: "external",
...
CoverLayout.propTypes = {
  ...
  showNavbar: PropTypes.bool, // Add prop type for showNavbar
};
